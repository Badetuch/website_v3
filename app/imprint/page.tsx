    ...
    <div className="flex flex-col min-h-screen">
      <main className="flex-grow py-[260px] pt-[110px] px-4 mx-auto max-w-fit content-center text-center">
        <div className="mb-4 leading-none md:text-5xl lg:text-6xl">
          ...
          <div className="text-[25px] py-4 tracking-normal leading-8 font-normal max-w-4xl text-second-text">
          ...
          <div className="text-[25px] py-3 tracking-normal leading-8 font-normal text-second-text">
